...
subprocess.Popen(["dieharder", "-d", "12", "-g", "202", "-f", lcg_out_filename], stdout=log_lcg, stderr=log_lcg)
...
subprocess.Popen(["dieharder", "-d", "12", "-g", "202", "-f", mersenne_out_filename], stdout=m_log, stderr=m_log)
...
subprocess.Popen(["dieharder", "-d", "12", "-g", "202", "-f", xoro_out_filename], stdout=x_log, stderr=x_log)
#subprocess.Popen(["dieharder", "-d", "14", "-g", "202", "-f", xoro_out_filename], stdout=x_log, stderr=x_log)
